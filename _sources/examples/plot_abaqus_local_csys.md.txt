...
direction of the local `y1`, `y2`, and `y3` axes.
...
and exports a PNG scene. Red, green, and blue arrows represent
...
The script writes `sg2_airfoil_local_csys.png` with the local-axis arrows
overlaid.
...
```{figure} ../../../examples/convert_abaqus_cs_to_vabs/sg2_airfoil_local_csys.png
:align: center
:width: 80%
```
...
- [sg2_airfoil_local_csys.png](../../../examples/convert_abaqus_cs_to_vabs/sg2_airfoil_local_csys.png): Generated PyVista screenshot.
