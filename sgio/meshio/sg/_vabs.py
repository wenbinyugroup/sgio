...
def write(filename, mesh, int_fmt='8d', float_fmt="20.9e"):
    """
    """
    if is_buffer(filename, 'w'):
        write_buffer(filename, mesh, int_fmt, float_fmt)
    else:
        with open(filename, 'at') as file:
            write_buffer(file, mesh, int_fmt, float_fmt)



def write_buffer(file, mesh, int_fmt='8d', float_fmt="20.9e"):
    """Writes msh files, cf.
    ...
    _write_nodes(file, mesh.points, int_fmt, float_fmt)
