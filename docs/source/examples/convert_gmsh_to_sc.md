...
```{literalinclude} ../../../examples/convert_gmsh_to_sc/convert_gmsh_to_sc.py
:language: python
```
...
- [convert_gmsh_to_sc.py](../../../examples/convert_gmsh_to_sc/convert_gmsh_to_sc.py): Main Python script
