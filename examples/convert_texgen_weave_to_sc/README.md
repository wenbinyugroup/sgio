...
- [run_1_api.py](run_1_api.py): conversion with SG arguments, plus rendering
- [run_2_manifest.py](run_2_manifest.py): the same conversion through the SG manifest
...
- [plain_weave_3d.sg.json](plain_weave_3d.sg.json): SG manifest referencing the deck
- [plain_weave_3d_sc21.sg](plain_weave_3d_sc21.sg): generated SwiftComp 2.1 Structure Gene
- [pyvista.png](pyvista.png): generated PyVista screenshot
