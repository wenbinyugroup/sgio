...
- `sg3-SD1-TE.sg`: isotropic baseline.
- `sg3-SD1-TE-ORTHO.sg`: orthotropic material with an elemental local coordinate system.
- `sg3-SD1-TE-ANISO.sg`: general-anisotropic material with an elemental local coordinate system.
