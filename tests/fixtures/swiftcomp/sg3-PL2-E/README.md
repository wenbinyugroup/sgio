...
- `sg3-PL2-E.sg`: isotropic baseline.
- `sg3-PL2-E-ORTHO.sg`: orthotropic material with an elemental local coordinate system.
- `sg3-PL2-E-ANISO.sg`: general-anisotropic material with an elemental local coordinate system.
