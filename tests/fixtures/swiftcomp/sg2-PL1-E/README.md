...
- `sg2-PL1-E.sg`: isotropic baseline.
- `sg2-PL1-E-ORTHO.sg`: orthotropic material with an elemental local coordinate system.
- `sg2-PL1-E-ANISO.sg`: general-anisotropic material with an elemental local coordinate system.
