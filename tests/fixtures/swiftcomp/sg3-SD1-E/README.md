...
- `sg3-SD1-E.sg`: isotropic baseline.
- `sg3-SD1-E-ORTHO.sg`: orthotropic material with an elemental local coordinate system.
- `sg3-SD1-E-ANISO.sg`: general-anisotropic material with an elemental local coordinate system.
