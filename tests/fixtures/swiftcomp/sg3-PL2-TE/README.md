...
- `sg3-PL2-TE.sg`: isotropic baseline.
- `sg3-PL2-TE-ORTHO.sg`: orthotropic material with an elemental local coordinate system.
- `sg3-PL2-TE-ANISO.sg`: general-anisotropic material with an elemental local coordinate system.
